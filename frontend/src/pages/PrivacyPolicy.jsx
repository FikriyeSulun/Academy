            ...
            <li>
              <div>
                ...
                <p>İnternet Sitemizi ziyaret etmeniz dolayısıyla elde edilen kişisel verileriniz aşağıda sıralanan amaçlarla Kurum tarafından KVK Kanunu’nun 5. ve 6. maddelerine uygun olarak işlenebilecektir:
                  ...
                  <br /><br />
                  Kurumun ve Kurumla iş ilişkisi içerisinde olan ilgili kişilerin hukuki, teknik ve ticari-iş güvenliğinin temin edilmesi</p>
              </div>
            </li>
            <li>
              <div>
            ...
            <li>
              <div>
                ...
                <p>Kişisel veri sahibi olarak Kanun’un 11. maddesi uyarınca aşağıdaki haklara sahip olduğunuzu bildiririz:
                  ...
                  <br /><br />
                  Yukarıda belirtilen haklarınızı kullanmak için kimliğinizi tespit edici gerekli bilgiler ile 6698 sayılı Kanunu’n 11. maddesinde belirtilen haklarınızdan kullanmayı talep ettiğiniz hakkınıza yönelik açıklamalarınızı içeren talebinizi; YES A.Ş.Web Sitesinde yer alan Başvuru Formu doldurarak ve formun imzalı bir nüshasını Maslak Mahallesi, Taşyoncası Sokak, No: 1V ve No:1Y Sarıyer-İSTANBUL  – Bina Kodu : 34481742, adresine kimliğinizi tespit edici belgeler ile bizzat elden iletebilir, noter kanalıyla veya 6698 sayılı Kanun’da belirtilen diğer yöntemler ile gönderebilir veya ilgili formu yesdijitall@gmail.com adresine güvenli elektronik imzalı olarak iletebilirsiniz.
                  <br /><br />
                  Talebinizin niteliğine göre en kısa sürede ve en geç otuz gün içinde başvurularınız ücretsiz olarak sonuçlandırılacaktır; ancak işlemin ayrıca bir maliyet gerektirmesi halinde Kişisel Verileri Koruma Kurulu tarafından belirlenecek tarifeye göre tarafınızdan ücret talep edilebilecektir.</p>
              </div>
            </li>
            <li>
              <div>
                ...
                <p>Kurum tarafından kişisel verilerin korunmasına ve veri güvenliğinin sağlanmasına verilen önem doğrultusunda, Kanun’un 12. maddesine uygun olarak, Kurumumuz tarafından veri güvenliğinin sağlanması için,
                  ...
                  <br /><br />
                  amacıyla uygun güvenlik düzeyini temin etmeye yönelik gerekli her türlü teknik ve idari tedbirleri almaktadır.</p>
              </div>
            </li>
            <li>
              <div>
            ...
            <li>
              <div>
                ...
                <p>Çerezler, ziyaret ettiğiniz internet siteleri tarafından tarayıcılar aracılığıyla cihazınıza veya ağ sunucusuna depolanan küçük metin dosyalarıdır. Çerezler konusundan daha detaylı bilgi için: http://www.aboutcookies.org/ ve http://www.allaboutcookies.org/ adreslerini ziyaret edebilirsiniz.
                  ...
                  <br /><br />
                  İnternet Sitesinin, sizin ve Kurum’un hukuki ve ticari güvenliğinin teminini sağlamak.</p>
              </div>
            </li>
            <li>
              <div>
